...
table = dynamo_client.Table('aqi_weather_3') #assign YOUR tablename here
datetime_unix = int(weather_json['dt'])
...
print(f'successfully uploaded weather record: {datetime_unix} / {utc}')